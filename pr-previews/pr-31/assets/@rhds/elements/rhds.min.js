...
import { __classPrivateFieldGet as __classPrivateFieldGet5, __decorate as __decorate14 } from "tslib";
...
var RhFooter = class extends LitElement11 {
  ...
  render() {
    const isMobile = __classPrivateFieldGet5(this, _RhFooter_matchMedia, "f").mediaQueryList?.matches ?? false;
    return html12`
      <footer class="base ${classMap3({ isMobile })}" part="base">
        <slot name="base">
              ...
              <div class="main-primary" part="main-primary">
                <slot name="main-primary">
                  <div class="links" part="links">
                    ${__classPrivateFieldGet5(this, _RhFooter_instances, "m", _RhFooter_renderLinksTemplate).call(this, isMobile)}
                  </div>
                </slot>
              </div>
  ...
  updateAccessibility() {
    ...
    for (const list of this.querySelectorAll(listsSelector)) {
      if (!list.hasAttribute("aria-labelledby")) {
        ...
        if (!header) {
          return __classPrivateFieldGet5(this, _RhFooter_logger, "f").warn("This links set doesn't have a valid header associated with it.");
        } else {
...
import { __classPrivateFieldGet as __classPrivateFieldGet8, __decorate as __decorate19 } from "tslib";
import { LitElement as LitElement16, html as html17 } from "lit";
import { customElement as customElement16, property as property12, query as query3, state as state4 } from "lit/decorators.js";
...
import { __classPrivateFieldGet as __classPrivateFieldGet6, __decorate as __decorate16 } from "tslib";
import { html as html14, LitElement as LitElement13 } from "lit";
import { customElement as customElement13, state as state2, query as query2, property as property11 } from "lit/decorators.js";
...
import { bound as bound3, observed as observed3 } from "@patternfly/pfe-core/decorators.js";
...
import { html as html13, LitElement as LitElement12 } from "lit";
import { customElement as customElement12, property as property10, query, state } from "lit/decorators.js";
...
var RhSecondaryNavMenu = /* @__PURE__ */ __name(class RhSecondaryNavMenu2 extends LitElement12 {
  constructor() {
    super(...arguments);
  ...
  connectedCallback() {
    super.connectedCallback();
    this.id || (this.id = getRandomId3("rh-secondary-nav-menu"));
  }
  render() {
    const classes = { "compact": this._compact, "visible": this.visible };
    return html13`
      <div id="container" class="${classMap4(classes)}">${this.layout === "full-width" ? html13`
...
RhSecondaryNavMenu = __decorate15([
  customElement12("rh-secondary-nav-menu")
], RhSecondaryNavMenu);
...
var SecondaryNavDropdownExpandEvent = class extends ComposedEvent {
...
var RhSecondaryNavDropdown = /* @__PURE__ */ __name(class RhSecondaryNavDropdown2 extends LitElement13 {
  constructor() {
    super(...arguments);
    _RhSecondaryNavDropdown_instances.add(this);
    _RhSecondaryNavDropdown_slots.set(this, new SlotController2(this, { slots: ["link", "menu"] }));
    _RhSecondaryNavDropdown_logger.set(this, new Logger6(this));
    this.expanded = false;
    this.colorPalette = "lighter";
  }
  connectedCallback() {
    super.connectedCallback();
    this.id || (this.id = getRandomId4("rh-secondary-nav-dropdown"));
    const [link] = __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("link");
    const [menu] = __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("menu");
    if (link === void 0) {
      __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_logger, "f").warn('[rh-secondary-nav-dropdown][slot="link"] expects a slotted <a> tag');
      return;
    }
    if (menu === void 0) {
      __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_logger, "f").warn('[rh-secondary-nav-dropdown][slot="menu"] expects a slotted <rh-secondary-nav-menu> tag');
      return;
    }
  ...
  render() {
    ...
    return html14`
      <div id="container" part="container" class="${classMap5(classes)}">
        <slot name="link"></slot>
        <slot name="menu"></slot>
      </div>
    `;
  ...
  _expandedChanged(oldVal, newVal) {
    ...
    newVal ? __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_instances, "m", _RhSecondaryNavDropdown_open).call(this) : __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_instances, "m", _RhSecondaryNavDropdown_close).call(this);
  }
  _clickHandler(event) {
...
_RhSecondaryNavDropdown_slots = /* @__PURE__ */ new WeakMap(), _RhSecondaryNavDropdown_logger = /* @__PURE__ */ new WeakMap(), _RhSecondaryNavDropdown_instances = /* @__PURE__ */ new WeakSet(), _RhSecondaryNavDropdown_open = /* @__PURE__ */ __name(function _RhSecondaryNavDropdown_open2() {
  const link = __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("link").find((child) => child instanceof HTMLAnchorElement);
  link?.setAttribute("aria-expanded", "true");
  const menu = __classPrivateFieldGet6(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("menu").find((child) => child instanceof RhSecondaryNavMenu);
  menu.visible = true;
...
__decorate16([
  colorContextProvider(),
  property11({ reflect: true, attribute: "color-palette" })
], RhSecondaryNavDropdown.prototype, "colorPalette", void 0);
__decorate16([
  bound3
], RhSecondaryNavDropdown.prototype, "_clickHandler", null);
RhSecondaryNavDropdown = __decorate16([
  customElement13("rh-secondary-nav-dropdown")
], RhSecondaryNavDropdown);

// elements/rh-secondary-nav/rh-secondary-nav-menu-section.js
import { __classPrivateFieldGet as __classPrivateFieldGet7, __decorate as __decorate17 } from "tslib";
...
var RhSecondaryNavMenuSection = /* @__PURE__ */ __name(class RhSecondaryNavMenuSection2 extends LitElement14 {
  constructor() {
    super(...arguments);
  ...
  connectedCallback() {
    super.connectedCallback();
    __classPrivateFieldGet7(this, _RhSecondaryNavMenuSection_instances, "m", _RhSecondaryNavMenuSection_updateAccessibility).call(this);
  }
  render() {
    return html15`
...
_RhSecondaryNavMenuSection_logger = /* @__PURE__ */ new WeakMap(), _RhSecondaryNavMenuSection_instances = /* @__PURE__ */ new WeakSet(), _RhSecondaryNavMenuSection_updateAccessibility = /* @__PURE__ */ __name(function _RhSecondaryNavMenuSection_updateAccessibility2() {
  ...
  for (const list of lists) {
    if (!list.hasAttribute("aria-labelledby")) {
      ...
      if (!header) {
        return __classPrivateFieldGet7(this, _RhSecondaryNavMenuSection_logger, "f").warn("This links set doesn't have a valid header associated with it.");
      } else {
        header.id || (header.id = getRandomId5("rh-secondary-nav-menu-section"));
        list.setAttribute("aria-labelledby", header.id);
      }
    }
  }
...
RhSecondaryNavMenuSection = __decorate17([
  customElement14("rh-secondary-nav-menu-section")
], RhSecondaryNavMenuSection);
...
import { customElement as customElement15, state as state3 } from "lit/decorators.js";
import { ComposedEvent as ComposedEvent2 } from "@patternfly/pfe-core";
import { observed as observed4 } from "@patternfly/pfe-core/decorators.js";
...
// elements/rh-secondary-nav/rh-secondary-nav-overlay.js
var SecondaryNavOverlayChangeEvent = class extends ComposedEvent2 {
...
var RhSecondaryNavOverlay = /* @__PURE__ */ __name(class RhSecondaryNavOverlay2 extends LitElement15 {
  constructor() {
    super(...arguments);
    this.open = false;
  }
...
RhSecondaryNavOverlay = __decorate18([
  customElement15("rh-secondary-nav-overlay")
], RhSecondaryNavOverlay);
...
var RhSecondaryNav = RhSecondaryNav_1 = /* @__PURE__ */ __name(class RhSecondaryNav2 extends LitElement16 {
  constructor() {
    super(...arguments);
    _RhSecondaryNav_instances.add(this);
    _RhSecondaryNav_logger.set(this, new Logger8(this));
  ...
  async connectedCallback() {
    ...
    __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_updateAccessibility).call(this);
  }
  firstUpdated() {
    this._overlay.addEventListener("click", this._overlayClickHandler);
  }
  render() {
    const navClasses = { compact: this._compact, rtl: __classPrivateFieldGet8(this, _RhSecondaryNav_dir, "f").dir === "rtl" };
    const containerClasses = { "expanded": this._mobileMenuExpanded };
    return html17`
      <nav part="nav" class="${classMap6(navClasses)}" aria-label="${__classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_setNavOrder).call(this)}">
        ${__classPrivateFieldGet8(this, _RhSecondaryNav_logoCopy, "f")}
        <div id="container" part="container" class="${classMap6(containerClasses)}">
          <slot name="logo" id="logo"></slot>
          <button aria-controls="container" aria-expanded="${this._mobileMenuExpanded}" @click="${__classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_toggleMobileMenu)}">Menu</button>
          <slot name="nav"></slot>
          <div id="cta" part="cta">
            <slot name="cta"><slot>
          </div>
  ...
  open(index) {
    ...
    const dropdown = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_dropdownByIndex).call(this, index);
    if (dropdown && RhSecondaryNav_1.isDropdown(dropdown)) {
      this.close();
      __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_expand).call(this, index);
      dropdown?.querySelector("a")?.focus();
      this._overlay.open = true;
    }
  }
  close() {
    const dropdowns = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_allDropdowns).call(this);
    dropdowns.forEach((dropdown) => __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_closeDropdown).call(this, dropdown));
  }
  _dropdownChangeHandler(event) {
    if (event instanceof SecondaryNavDropdownExpandEvent) {
      const index = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getDropdownIndex).call(this, event.target);
  ...
  __compactChanged(oldVal, newVal) {
    ...
    const dropdownsOpen = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getOpenDropdowns).call(this).length;
    if (newVal === true) {
      if (dropdownsOpen > 0) {
    ...
    switch (event.key) {
      case "Escape":
        if (this._compact) {
          ...
          const open = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getOpenDropdowns).call(this);
...
_RhSecondaryNav_logger = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_logoCopy = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_dir = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_instances = /* @__PURE__ */ new WeakSet(), _RhSecondaryNav_getOpenDropdowns = /* @__PURE__ */ __name(function _RhSecondaryNav_getOpenDropdowns2() {
  ...
  if (!RhSecondaryNav_1.isDropdown(element)) {
    __classPrivateFieldGet8(this, _RhSecondaryNav_logger, "f").warn("The getDropdownIndex method expects to receive a dropdown element.");
    return;
  }
  const dropdowns = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_allDropdowns).call(this);
  ...
  if (dropdowns[index] === void 0) {
    __classPrivateFieldGet8(this, _RhSecondaryNav_logger, "f").error("This dropdown index does not exist.");
    return;
  }
  ...
  const dropdown = __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_dropdownByIndex).call(this, index);
  if (dropdown && RhSecondaryNav_1.isDropdown(dropdown)) {
    __classPrivateFieldGet8(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_openDropdown).call(this, dropdown);
  }
...
__decorate19([
  query3("rh-secondary-nav-overlay")
...
__decorate19([
  property12({ reflect: true, attribute: "main", type: Boolean })
...
RhSecondaryNav = RhSecondaryNav_1 = __decorate19([
  customElement16("rh-secondary-nav")
], RhSecondaryNav);

// elements/rh-stat/rh-stat.js
import { __classPrivateFieldGet as __classPrivateFieldGet9, __decorate as __decorate20 } from "tslib";
import { LitElement as LitElement17, html as html18 } from "lit";
import { customElement as customElement17, property as property13 } from "lit/decorators.js";
...
var RhStat = /* @__PURE__ */ __name(class RhStat2 extends LitElement17 {
  constructor() {
    super(...arguments);
    ...
    _RhStat_slots.set(this, new SlotController3(this, null, "icon", "title", "statistic", "cta"));
    _RhStat_mo.set(this, new MutationObserver(() => __classPrivateFieldGet9(this, _RhStat_instances, "m", _RhStat_onMutation).call(this)));
    _RhStat_logger.set(this, new Logger9(this));
  }
  connectedCallback() {
    super.connectedCallback();
    __classPrivateFieldGet9(this, _RhStat_instances, "m", _RhStat_updateIcons).call(this);
    __classPrivateFieldGet9(this, _RhStat_mo, "f").observe(this, { childList: true });
    __classPrivateFieldGet9(this, _RhStat_instances, "m", _RhStat_onMutation).call(this);
  }
  render() {
    const hasIcon = __classPrivateFieldGet9(this, _RhStat_slots, "f").hasSlotted("icon") || !!this.icon;
    const hasTitle = __classPrivateFieldGet9(this, _RhStat_slots, "f").hasSlotted("title");
    const hasStatistic = __classPrivateFieldGet9(this, _RhStat_slots, "f").hasSlotted("statistic");
    const hasCta = __classPrivateFieldGet9(this, _RhStat_slots, "f").hasSlotted("cta");
    const isMobile = !__classPrivateFieldGet9(this, _RhStat_screenSize, "f").matches.has("tabletPortrait");
    return html18`
      <div class="${classMap7({ isMobile, hasIcon, hasTitle, hasStatistic, hasCta })}">
        <span id="icon">
          <slot name="icon" @slotchange="${__classPrivateFieldGet9(this, _RhStat_instances, "m", _RhStat_updateIcons)}">${!this.icon ? "" : html18`
...
_RhStat_screenSize = /* @__PURE__ */ new WeakMap(), _RhStat_slots = /* @__PURE__ */ new WeakMap(), _RhStat_mo = /* @__PURE__ */ new WeakMap(), _RhStat_logger = /* @__PURE__ */ new WeakMap(), _RhStat_instances = /* @__PURE__ */ new WeakSet(), _RhStat_updateIcons = /* @__PURE__ */ __name(function _RhStat_updateIcons2() {
  ...
  if (!__classPrivateFieldGet9(this, _RhStat_slots, "f").hasSlotted("stat")) {
    __classPrivateFieldGet9(this, _RhStat_logger, "f").warn("Must contain stat content");
  }
  if (!this.querySelectorAll(":not([slot])").length) {
    __classPrivateFieldGet9(this, _RhStat_logger, "f").warn("Must contain description content");
  }
}, "_RhStat_onMutation");
...
__decorate20([
  property13({ reflect: true, type: String })
...
__decorate20([
  property13({ type: Boolean, reflect: true, attribute: "is-mobile" })
], RhStat.prototype, "isMobile", void 0);
RhStat = __decorate20([
  customElement17("rh-stat")
], RhStat);
...
var styles19 = css21`:host([on="dark"]) {
...
RhTooltip = __decorate21([
  customElement18("rh-tooltip")
], RhTooltip);
export {
  ContextProvider,
  RhAlert,
