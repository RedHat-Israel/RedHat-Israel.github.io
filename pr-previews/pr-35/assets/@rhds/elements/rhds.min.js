...
import { __classPrivateFieldGet as __classPrivateFieldGet7, __decorate as __decorate15 } from "tslib";
...
var RhSecondaryNavMenuSection = /* @__PURE__ */ __name(class RhSecondaryNavMenuSection2 extends LitElement12 {
  constructor() {
    super(...arguments);
    _RhSecondaryNavMenuSection_instances.add(this);
    _RhSecondaryNavMenuSection_logger.set(this, new Logger6(this));
  }
  connectedCallback() {
    super.connectedCallback();
...
RhSecondaryNavMenuSection = __decorate15([
  customElement12("rh-secondary-nav-menu-section")
], RhSecondaryNavMenuSection);
...
var RhSecondaryNavOverlay = /* @__PURE__ */ __name(class RhSecondaryNavOverlay2 extends LitElement13 {
  constructor() {
    super(...arguments);
    this.open = false;
  }
...
RhSecondaryNavOverlay = __decorate16([
  customElement13("rh-secondary-nav-overlay")
], RhSecondaryNavOverlay);

// elements/rh-secondary-nav/rh-secondary-nav-dropdown.js
import { __classPrivateFieldGet as __classPrivateFieldGet8, __decorate as __decorate18 } from "tslib";
import { html as html16, LitElement as LitElement15 } from "lit";
import { customElement as customElement15, state as state3, query as query2, property as property11 } from "lit/decorators.js";
...
import { customElement as customElement14, property as property10, query, state as state2 } from "lit/decorators.js";
...
var RhSecondaryNavMenu = /* @__PURE__ */ __name(class RhSecondaryNavMenu2 extends LitElement14 {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return html15`
      <div id="container" class="${classMap5(classes)}">${this.layout === "full-width" ? html15`
...
RhSecondaryNavMenu = __decorate17([
  customElement14("rh-secondary-nav-menu")
], RhSecondaryNavMenu);
...
var RhSecondaryNavDropdown = /* @__PURE__ */ __name(class RhSecondaryNavDropdown2 extends LitElement15 {
  constructor() {
    super(...arguments);
    ...
    _RhSecondaryNavDropdown_logger.set(this, new Logger7(this));
    this.expanded = false;
  ...
  connectedCallback() {
    ...
    const [link] = __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("link");
    const [menu] = __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("menu");
    if (link === void 0) {
      __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_logger, "f").warn('[rh-secondary-nav-dropdown][slot="link"] expects a slotted <a> tag');
      return;
    }
    if (menu === void 0) {
      __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_logger, "f").warn('[rh-secondary-nav-dropdown][slot="menu"] expects a slotted <rh-secondary-nav-menu> tag');
      return;
    }
  ...
  render() {
    ...
    return html16`
      <div id="container" part="container" class="${classMap6(classes)}">
        <slot name="link"></slot>
        <slot name="menu"></slot>
      </div>
    `;
  ...
  _expandedChanged(oldVal, newVal) {
    ...
    newVal ? __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_instances, "m", _RhSecondaryNavDropdown_open).call(this) : __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_instances, "m", _RhSecondaryNavDropdown_close).call(this);
  }
  _clickHandler(event) {
...
_RhSecondaryNavDropdown_slots = /* @__PURE__ */ new WeakMap(), _RhSecondaryNavDropdown_logger = /* @__PURE__ */ new WeakMap(), _RhSecondaryNavDropdown_instances = /* @__PURE__ */ new WeakSet(), _RhSecondaryNavDropdown_open = /* @__PURE__ */ __name(function _RhSecondaryNavDropdown_open2() {
  const link = __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("link").find((child) => child instanceof HTMLAnchorElement);
  link?.setAttribute("aria-expanded", "true");
  const menu = __classPrivateFieldGet8(this, _RhSecondaryNavDropdown_slots, "f").getSlotted("menu").find((child) => child instanceof RhSecondaryNavMenu);
  menu.visible = true;
...
RhSecondaryNavDropdown = __decorate18([
  customElement15("rh-secondary-nav-dropdown")
], RhSecondaryNavDropdown);
...
var RhSecondaryNav = RhSecondaryNav_1 = /* @__PURE__ */ __name(class RhSecondaryNav2 extends LitElement16 {
  ...
  async connectedCallback() {
    ...
    __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_updateAccessibility).call(this);
  }
  firstUpdated() {
  ...
  render() {
    const navClasses = { compact: this._compact, rtl: __classPrivateFieldGet9(this, _RhSecondaryNav_dir, "f").dir === "rtl" };
    const containerClasses = { "expanded": this._mobileMenuExpanded };
    return html17`
      <nav part="nav" class="${classMap7(navClasses)}" aria-label="${__classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_setNavOrder).call(this)}">
        ${__classPrivateFieldGet9(this, _RhSecondaryNav_logoCopy, "f")}
        <div id="container" part="container" class="${classMap7(containerClasses)}">
          <slot name="logo" id="logo"></slot>
          <button aria-controls="container" aria-expanded="${this._mobileMenuExpanded}" @click="${__classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_toggleMobileMenu)}">Menu</button>
          <slot name="nav"></slot>
          <div id="cta" part="cta">
  ...
  open(index) {
    ...
    const dropdown = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_dropdownByIndex).call(this, index);
    if (dropdown && RhSecondaryNav_1.isDropdown(dropdown)) {
      this.close();
      __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_expand).call(this, index);
      dropdown?.querySelector("a")?.focus();
      this._overlay.open = true;
    }
  }
  close() {
    const dropdowns = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_allDropdowns).call(this);
    dropdowns.forEach((dropdown) => __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_closeDropdown).call(this, dropdown));
  }
  _dropdownChangeHandler(event) {
    if (event instanceof SecondaryNavDropdownExpandEvent) {
      const index = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getDropdownIndex).call(this, event.target);
  ...
  __compactChanged(oldVal, newVal) {
    ...
    const dropdownsOpen = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getOpenDropdowns).call(this).length;
    if (newVal === true) {
      if (dropdownsOpen > 0) {
    ...
    switch (event.key) {
      case "Escape":
        if (this._compact) {
          ...
          const open = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_getOpenDropdowns).call(this);
...
_RhSecondaryNav_logger = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_logoCopy = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_dir = /* @__PURE__ */ new WeakMap(), _RhSecondaryNav_instances = /* @__PURE__ */ new WeakSet(), _RhSecondaryNav_getOpenDropdowns = /* @__PURE__ */ __name(function _RhSecondaryNav_getOpenDropdowns2() {
  ...
  if (!RhSecondaryNav_1.isDropdown(element)) {
    __classPrivateFieldGet9(this, _RhSecondaryNav_logger, "f").warn("The getDropdownIndex method expects to receive a dropdown element.");
    return;
  }
  const dropdowns = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_allDropdowns).call(this);
  ...
  if (dropdowns[index] === void 0) {
    __classPrivateFieldGet9(this, _RhSecondaryNav_logger, "f").error("This dropdown index does not exist.");
    return;
  }
  ...
  const dropdown = __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_dropdownByIndex).call(this, index);
  if (dropdown && RhSecondaryNav_1.isDropdown(dropdown)) {
    __classPrivateFieldGet9(this, _RhSecondaryNav_instances, "m", _RhSecondaryNav_openDropdown).call(this, dropdown);
  }
...
var RhStat = /* @__PURE__ */ __name(class RhStat2 extends LitElement17 {
  constructor() {
    ...
    _RhStat_mo.set(this, new MutationObserver(() => __classPrivateFieldGet10(this, _RhStat_instances, "m", _RhStat_onMutation).call(this)));
    _RhStat_logger.set(this, new Logger9(this));
  }
  connectedCallback() {
    super.connectedCallback();
    __classPrivateFieldGet10(this, _RhStat_instances, "m", _RhStat_updateIcons).call(this);
    __classPrivateFieldGet10(this, _RhStat_mo, "f").observe(this, { childList: true });
    __classPrivateFieldGet10(this, _RhStat_instances, "m", _RhStat_onMutation).call(this);
  }
  render() {
    const hasIcon = __classPrivateFieldGet10(this, _RhStat_slots, "f").hasSlotted("icon") || !!this.icon;
    const hasTitle = __classPrivateFieldGet10(this, _RhStat_slots, "f").hasSlotted("title");
    const hasStatistic = __classPrivateFieldGet10(this, _RhStat_slots, "f").hasSlotted("statistic");
    const hasCta = __classPrivateFieldGet10(this, _RhStat_slots, "f").hasSlotted("cta");
    const isMobile = !__classPrivateFieldGet10(this, _RhStat_screenSize, "f").matches.has("tabletPortrait");
    return html18`
      <div class="${classMap8({ isMobile, hasIcon, hasTitle, hasStatistic, hasCta })}">
        <span id="icon">
          <slot name="icon" @slotchange="${__classPrivateFieldGet10(this, _RhStat_instances, "m", _RhStat_updateIcons)}">${!this.icon ? "" : html18`
...
_RhStat_screenSize = /* @__PURE__ */ new WeakMap(), _RhStat_slots = /* @__PURE__ */ new WeakMap(), _RhStat_mo = /* @__PURE__ */ new WeakMap(), _RhStat_logger = /* @__PURE__ */ new WeakMap(), _RhStat_instances = /* @__PURE__ */ new WeakSet(), _RhStat_updateIcons = /* @__PURE__ */ __name(function _RhStat_updateIcons2() {
  ...
  if (!__classPrivateFieldGet10(this, _RhStat_slots, "f").hasSlotted("stat")) {
    __classPrivateFieldGet10(this, _RhStat_logger, "f").warn("Must contain stat content");
  }
  if (!this.querySelectorAll(":not([slot])").length) {
    __classPrivateFieldGet10(this, _RhStat_logger, "f").warn("Must contain description content");
  }
}, "_RhStat_onMutation");
